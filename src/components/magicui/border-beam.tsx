    ...
    >
      <div
        ...
        style={{
          ...
          maskImage: 'radial-gradient(circle, transparent 0%, transparent calc(100% - 3px), black calc(100% - 3px))',
          WebkitMaskImage: 'radial-gradient(circle, transparent 0%, transparent calc(100% - 3px), black calc(100% - 3px))',
        }}
      />
    </div>
  )
