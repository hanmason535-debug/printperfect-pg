  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        {name: 'keywords', title: 'Keywords', type: 'array', of: [{type: 'string'}], description: 'SEO keywords for this portfolio item'},
        {name: 'ogImage', title: 'Social Share Image', type: 'image', description: 'Image shown when shared on social media (optional, defaults to portfolio image)'},
      ],
      options: {
        collapsible: true,
        collapsed: true,
